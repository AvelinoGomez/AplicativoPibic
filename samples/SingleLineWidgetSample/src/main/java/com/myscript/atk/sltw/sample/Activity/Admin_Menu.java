...
public class Admin_Menu extends AppCompatActivity {
    ...
    private void deslogarUsuario() {
        ...
        Intent intent = new Intent(Admin_Menu.this, Login_activity.class);
        startActivity(intent);
        finish();
    }

    private void irParaTelaListar(){
        Intent intent = new Intent(Admin_Menu.this, Admin_ListarUsuarios.class);
        startActivity(intent);
    }
    ...
    private void irParaTelaConfig(String uid){
            ...
            Intent intentirParaTelaConfig = new Intent( Admin_Menu.this,Admin_Config.class);
