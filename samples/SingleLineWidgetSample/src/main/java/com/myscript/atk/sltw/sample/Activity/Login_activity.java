...
public class Login_activity extends AppCompatActivity {
    ...
    public void abrirTelaPrincipalAdm(String uid){
        ...
        Intent intentAbrirTelaPrincipal = new Intent(Login_activity.this,Admin_Menu.class);
    ...
    public void abrirTelaPrincipalComum(String uid){
        Bundle bundle = new Bundle();
        bundle.putString("uid",uid);
        Intent intentAbrirTelaPrincipal = new Intent(Login_activity.this,Usuario_Menu.class);
        intentAbrirTelaPrincipal.putExtras(bundle);
        startActivity(intentAbrirTelaPrincipal);
        finish();
    }
    ...
    private void verifaUsuarioLogado() {
        ...
        if (autenticacao.getCurrentUser() != null) {
            Intent intent = new Intent(Login_activity.this, Usuario_Menu.class);
            startActivity(intent);
            finish();
        }
    }
