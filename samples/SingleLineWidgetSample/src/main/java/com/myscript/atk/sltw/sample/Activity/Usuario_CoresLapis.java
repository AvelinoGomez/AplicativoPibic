...
public class Usuario_CoresLapis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paleta_cores_lapis);
        ...
        Toast.makeText(context, "Escolha uma cor para seu Lápis!", Toast.LENGTH_LONG).show();

        Button paleta_Verde = (Button)findViewById(R.id.paleta_btnVerde);
        Button paleta_Amarelo = (Button)findViewById(R.id.paleta_btnAmarelo);
        Button paleta_Azul = (Button)findViewById(R.id.paleta_btnAzul);
        Button paleta_Cinza = (Button)findViewById(R.id.paleta_btnCinza);
        Button paleta_Esmeralda = (Button)findViewById(R.id.paleta_btnEsmeralda);
        Button paleta_Laranja = (Button)findViewById(R.id.paleta_btnLaranja);
        Button paleta_Marrom = (Button)findViewById(R.id.paleta_btnMarrom);
        Button paleta_Preto = (Button)findViewById(R.id.paleta_btnPreto);
        Button paleta_Rosa = (Button)findViewById(R.id.paleta_btnRosa);
        Button paleta_Roxo = (Button)findViewById(R.id.paleta_btnRoxo);
        Button paleta_Vermelho = (Button)findViewById(R.id.paleta_btnVermelho);
        Button paleta_Violeta = (Button)findViewById(R.id.paleta_btnVioleta);
    ...
    void SetarCorUsuario(int r,int g,int b,View v){
        usuario.setCorLapis(""+Color.rgb(r,g,b));
